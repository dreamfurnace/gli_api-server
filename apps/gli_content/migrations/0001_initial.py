    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_investment_glib', models.DecimalField(decimal_places=8, max_digits=20, validators=[django.core.validators.MinValueValidator(0)])),
                ('max_investment_glib', models.DecimalField(blank=True, decimal_places=8, max_digits=20, null=True)),
                ...
                ('total_invested_glib', models.DecimalField(decimal_places=8, default=0, max_digits=20)),
                ('investor_count', models.PositiveIntegerField(default=0)),
                ('funding_target_glib', models.DecimalField(blank=True, decimal_places=8, max_digits=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('amount_glib', models.DecimalField(decimal_places=8, max_digits=20, validators=[django.core.validators.MinValueValidator(0)])),
                ...
                ('current_value_glib', models.DecimalField(decimal_places=8, default=0, max_digits=20)),
                ('realized_profit_glib', models.DecimalField(decimal_places=8, default=0, max_digits=20)),
